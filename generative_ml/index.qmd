...
x = g(z).
$$
In this case $g(z)$ is the inverse cumalative distribution function of $x$. The first generative model that we'll dicuss does the same thing by replacing $x$ with images and $g(z)$ with a neural network.
